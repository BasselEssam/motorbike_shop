...
class Ducati extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 0,
          title:
          Text("DUCATI Products",style: GoogleFonts.aBeeZee(fontSize: 20,fontWeight: FontWeight.bold),),
        ),
        body:FutureBuilder(
            future: FirebaseFirestore.instance.collection('brands').doc('sCyCK3WPVlzvnIaMNBVs').collection('ducati').get(),
